...
/**
 * BuscarFacturaFrame - muestra facturas por cédula.
 * Esta versión espera que FacturaRepository.buscarPorCedula(String)
 * devuelva ArrayList<String> donde cada String es un bloque de texto
 * con la factura (formato guardado en facturas.txt).
 */
public class BuscarFacturaFrame extends javax.swing.JFrame {
    ...
    private void buscar() {
        ...
        // Concatenar todas las facturas encontradas y mostrarlas en el textarea
        ...
        txtResultados.setCaretPosition(0); // subir al inicio
    }
