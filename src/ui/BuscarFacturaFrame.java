...
/**
 * BuscarFacturaFrame - muestra facturas por cédula en texto legible.
 * Usa FacturaRepository.buscarPorCedulaTexto(...)
 */
public class BuscarFacturaFrame extends javax.swing.JFrame {
    ...
    public BuscarFacturaFrame() {
        facturaRepo = new FacturaRepository(); // carga desde archivo al crear
        initComponents();
        setSize(800, 600);
        setResizable(true);
    ...
    private void buscar() {
        ...
        List<String> resultados = facturaRepo.buscarPorCedulaTexto(cedula);
